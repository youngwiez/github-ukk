...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="kategori">
            ...
            <!-- Nav Item - Kategori -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('kategori.index') }}" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <!-- Nav Item - Pemasukan -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('pemasukan.index') }}" data-toggle="collapse" data-target="#collapseThree"
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manajemen Pemasukan</h6>
                        <a class="collapse-item" href="{{ route('pemasukan.index') }}">Data Pemasukan</a>
                        <a class="collapse-item" href="{{ route('pemasukan.create') }}">Tambah Pemasukan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('pengeluaran.index') }}" data-toggle="collapse" data-target="#collapseFour"
                    aria-expanded="true" aria-controls="collapseTwo">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('pengeluaran.create') }}">Tambah Pengeluaran</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-3 mt-3">
                        <h1 class="h3 mb-0 text-gray-800">
                            <strong>Selamat Datang di Sinvent!</strong>
                        </h1>
                    </div>
                ...
                <div class="container-fluid">
                    ...
                    <!-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Selamat Datang di Sinvent!</h1>
                    </div> -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SIJA Stembayo 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
